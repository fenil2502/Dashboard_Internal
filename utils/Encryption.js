...
const AESKeyValue = CryptoJS.lib.WordArray.random(32).toString(CryptoJS.enc.Base64);

// Generate a random initialization vector (IV)
const AESIVKey = CryptoJS.lib.WordArray.random(16).toString(CryptoJS.enc.Base64);
