...
// export const APIURL = "http://api.dashboardproject.in/api/";
export const APIURL = "https://api.dashboardproject.in/api/";
// export const APIURL = "http://localhost:5105/api/";

export const GetAllEmployee = "DashBoard/GetAllEmployee";
export const GetEmployeeDetailsById = "DashBoard/GetEmployeeDetailsById?id={0}";
export const uploadPDF = "Common/UploadPDF";
export const StoreBase64Image = "DashBoard/StoreBase64Image";;
export const UploadReconciliationExcel = "Finance/UploadReconciliationExcel";
export const GenerateToken = "Common/GenerateToken";
export const AddUser = "DashBoard/AddUser";
export const UserLogin = "DashBoard/UserLogin";
export const GetDashboardDetailsById = "DashBoard/GetDashboardDetailsById?id={0}";
export const EditUserDetails = "DashBoard/EditUserDetails";
export const getImage = "DashBoard/getImage";
export const AddEditNewTask = "DashBoard/AddEditNewTask";
