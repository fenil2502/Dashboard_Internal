...
class SwalServices {
  ...
  async Confirm(title, text, saveBtnText, cancelBtnText) {
    return (MySwal.fire({
      ...
      text: text,
      icon: 'question',
      iconHtml: '<span className="warning-body"><span className="warnning-icons"><img src="/error.png"/></span>',
  ...
  async Warning(text) {
    MySwal.fire({
      ...
      text: text,
      icon: "warning",
      iconHtml: '<span className="warning-body"></span><span className="warnning-icons"><img src="/error.png"/></span>',
      showCancelButton: true,
      allowOutsideClick: false,
      allowEscapeKey: true,
      reverseButtons: true
  ...
  async Success(text) {
    await MySwal.fire({
      ...
      text: text,
      icon: "success",
      iconHtml: '<div class="custom-msg"><span className="sa-line success-tip"></span><span className="sucess-icons"><img src="/check.png"/></span></div>',
      showCancelButton: false,
  ...
  async Toaster(text) {
    MySwal.fire({
      ...
      toast: true,
      icon: "success",
      iconHtml: '<div class="custom-msg"><span className="sucess-icons"><img src="/check.png"/></span><div>',
      position: 'top-end',
  ...
  async ThankYou(title, text) {
    MySwal.fire({
      ...
      text: text,
      icon: "info",
      iconHtml: '<span className="sucess-icons"><img src="/check.png"/></span>',
      showCancelButton: false,
      allowOutsideClick: false,
      allowEscapeKey: true
    });
